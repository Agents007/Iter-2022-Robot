...
void QTRSensors::defineCalibrate(int CalibrateMin, int CalibrateMax, int capteur){
  minSensorValues[capteur] = CalibrateMin;
  maxSensorValues[capteur] = CalibrateMax;
}

int QTRSensors::readCalibrateMinMy(int capteur){
  return minSensorValues[capteur]; 
}

int QTRSensors::readCalibrateMaxMy(int capteur){
  return maxSensorValues[capteur];
}
